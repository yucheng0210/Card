	...
	SubShader
	{
		...
		{ 
			...
			half4 frag ( v2f_img_custom i ) : SV_Target
			{
				...
				float4 SceneColor7 = tex2D( _MainTex, uv_MainTex );
				...
				float3 ColorRGB38 = (_Color).rgb;
				float ColorA40 = _Color.a;
				float4 lerpResult2 = lerp( SceneColor7 , float4( ( MaskedSpeedLines29 * ColorRGB38 ) , 0.0 ) , ( MaskedSpeedLines29 * ColorA40 ));
...
Node;AmplifyShaderEditor.ColorNode;33;-2736.949,911.6467;Inherit;False;Property;_Color;Color;0;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;40;-2299.421,1009.243;Inherit;False;ColorA;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;38;-2282.18,918.6451;Inherit;False;ColorRGB;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;46;-934.8308,-32.66438;Inherit;False;38;ColorRGB;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;7;-2189.996,-922.8203;Inherit;False;SceneColor;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;44;-998.1222,224.127;Inherit;False;40;ColorA;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;8;-692.7988,-218.4032;Inherit;False;7;SceneColor;1;0;OBJECT;;False;1;COLOR;0
